...
const TaxResultSpouseEmployee = ({tax,socialContributions,spouseSocialContributions,healthContribution,spouseHealthContribution}) => {
    return (
...
export default TaxResultSpouseEmployee;