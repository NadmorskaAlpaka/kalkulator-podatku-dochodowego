...
const CalculateTaxScaleForYouth = ({data}) => {
    ...
    // Składka zdrowotna
    let spouseHealthContributionValue = 0;
    ...
    if(taxData.taxWithSpous){
        spouseHealthContributionValue = calculateHealthContributionsForTaxScale(taxData.spouseIncome, healthCountributions.taxScale.valuePercentage);
    }
